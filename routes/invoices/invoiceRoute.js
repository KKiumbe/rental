...
const { generateBuildingUtilityInvoices } = require('../../controller/bill/sharedutilitybill.js');
...
router.post('/shared-utility-bill',verifyToken, generateBuildingUtilityInvoices);
